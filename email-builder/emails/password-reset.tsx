			...
			<Body className="bg-[#efeef1] font-twitch">
				...
				<Container className="max-w-145 mx-auto bg-white">
					<Section className="py-4">
						<Img width={114} src={`http://localhost:8000/static/price-pulse.svg`} alt="PricePulse" className="mx-auto" />
					</Section>
					...
					<Section className="pt-1.25 px-5 pb-2.5">
						...
						<Text className="text-[14px] leading-normal">To reset your password, please click the button below:</Text>
						<Section className="text-center my-6">
							<Button href="{{ resetLink }}" className="bg-[#007ACC] text-white text-[16px] font-semibold py-2.5 px-6 rounded-md">
								Reset Password
							</Button>
						</Section>
						<Text className="">
							If the button above does not work, please copy and paste the following link into your web browser:
							<Link href="{{ resetLink }}" className="break-all text-[#007ACC]">
								{'{{ resetLink }}'}
							</Link>
						</Text>
						<Text className="text-[14px] leading-normal">
